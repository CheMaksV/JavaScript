...
function printerParagraph(text) {
...
function printerLists(text, numList) {
    document.write(`<ul>`);
...
function printerListOfArray(arrayOfPrimitives) {
    document.write(`<ul>`);
...
function printerListsOfArray(array) {
    document.write(`<ul>`);
    for (let item of array) {
